...
window.onload = function () {
  $("#ol").html(
    `<center><div id="inst"><h3>Welcome !</h3><p style="font-size:18px;">Silahkan pilih mode memory game nya</p></div><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button></center>`
  );
};
